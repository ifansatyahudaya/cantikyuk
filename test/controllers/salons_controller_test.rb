...
class SalonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salon" do
    assert_difference('Salon.count') do
      post salons_url, params: { salon: { address: @salon.address, lat: @salon.lat, lng: @salon.lng, name: @salon.name, phone: @salon.phone } }
    end
  ...
  test "should update salon" do
    patch salon_url(@salon), params: { salon: { address: @salon.address, lat: @salon.lat, lng: @salon.lng, name: @salon.name, phone: @salon.phone } }
